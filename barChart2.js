class BarChart2 {
  ...
  constructor(_config, _data, _colorid) {
    this.config = {
      ...
      margin: { top: 15, bottom: 60, right: 50, left: 60 }
    }
  ...
  initVis() {
    ...
    vis.svg.append("text")
        ...
        .text("Level of Health Concern in Selected Year")
  ...
  updateVis(data) {
    ...
    vis.chart.selectAll(".labels")
        ...
        .join("text")
            ...
            .attr("x", function(d){
                    return vis.xScale(d.cat) + vis.xScale.bandwidth() / 2;
                 })
            .attr("y", function(d){
                    return vis.height - 5;
                 })
